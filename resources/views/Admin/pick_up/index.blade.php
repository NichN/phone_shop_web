...
<div>
    ...
    <div class="w3-main">
        <main style="padding:30px; gap:10px;" class="row">
            <div style="background-color: #87ceeb; padding: 10px; border-radius: 8px; width: 180px;">
                    <div>
            ...
            <div style="background-color: #87ceeb; padding: 10px; border-radius: 8px; width: 180px;">
                    <div>
                        <p style="margin: 0; font-weight: bold;">Total Income (Processing)</p>
                        <h2 id="total-income" style="margin: 20px auto 0; 
            ...
            <div style="background-color: #87ceeb; padding: 10px; border-radius: 8px; width: 180px;">
                    <div>
                        <p style="margin: 0; font-weight: bold;">Total Income (completed)</p>
                        <h2 id="total-income" style="margin: 20px auto 0; 
                            text-align: center; font-size: 20px; color: black; padding: 10px;"> USD
                        {{$total_fee ?? 0}}
                    </h2>
