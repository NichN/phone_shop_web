...
<div class="w3-main">
    <div class="container mt-4">
        ...
        <div class="row g-4">
            <div class="col-md-3">
                <a href="{{ route('products.product_index') }}" class="text-decoration-none">
                    <div class="card shadow-sm" style="border-radius: 12px; height: 150px; box-shadow: 2px 4px 10px rgba(0, 0, 0, 0.1); border: 2px solid rgb(39, 67, 158); cursor: pointer;">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="text-center text-md-start">
                                    <div class="small mb-1 text-muted">
                                        Total Products <span class="text-success">(Active)</span>
                                    </div>
                                    <h3 class="fw-bold mb-0">{{$total_product}}</h3>
                                    <div class="small fw-bold text-success">This Month</div>
            ...
            <div class="col-md-3">
                 <a href="{{ route('customer_admin.index') }}" class="text-decoration-none">
                    <div class="card shadow-sm" style="border-radius: 12px; height: 150px; box-shadow: 2px 4px 10px rgba(0, 0, 0, 0.1); border: 2px solid rgb(39, 67, 158); cursor: pointer;">
                        <div class="card-body d-flex flex-column justify-content-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="text-center text-md-start">
                                    <div class="small mb-1 text-muted" style="color: black;"><b>Monthly Buyers</b></div>
            ...
            <div class="col-md-3">
                <a href="{{ route('order_dashboard.index') }}" class="text-decoration-none">
                 <div class="card shadow-sm" style="border-radius: 12px; height: 150px;  box-shadow: 2px 4px 10px rgba(0, 0, 0, 0.1);   border : 2px solid rgb(39, 67, 158);">
                    <div class="card-body d-flex flex-column justify-content-center">
                        <div class="d-flex align-items-center gap-3">
                            <div class="bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center"
            ...
            <div class="col-6 col-md-3">
                <a href="/order_dashboard" class="btn btn-light border text-dark w-100 py-3 position-relative">
                    ...
                    <p class="text-warning fw-bold mb-0 mt-2">Order</p>
                </a>
            </div>
            <div class="col-6 col-md-3">
            ...
            <div class="col-md-6">
                    <div class="card border-0 shadow-sm h-100" style="border-radius: 16px; background: #fefefe;">
                        ...
                        @forelse ($recentOrders as $order)
                            <a href="{{ route('order_dashboard.order_detail', $order->id) }}" 
                            class="d-flex align-items-center mb-4 p-2 rounded hover-shadow text-decoration-none"
