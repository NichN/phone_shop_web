                    ...
                    <div class="card-body">
                        <div class="card-header d-flex rounded justify-content-between align-items-center" style="background-color: #2e3b56;">
                            <h4 style="font-size: 1.2rem; font-weight: bold;">
                                <i class="fa fa-credit-card" aria-hidden="true"></i> Order Completed
                            </h4>
                        </div>
                        <br>
...
<script>
    $(document).ready(function(){
        var table = $('.data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('report.sale_completed') }}",
                data: function (d) {
...
<style>
    #felter-report input.form-control,
    #felter-report select.form-select {
    border: 1px solid #ccc;
    transition: border-color 0.3s ease;
    }

    #felter-report input.form-control:focus,
    #felter-report select.form-select:focus {
    border-color: #999;
    box-shadow: none; 
    }
</style>
