...
<style>
    .payment-container {
        ...
        margin-top: 50px;
        padding-bottom: 50px; /* Added bottom padding for space */
    }
...
<div class="container payment-container">
    ...
    <div class="payment-box">
        ...
        <form action="{{ route('payment.process') }}" method="POST">
            ...
            <input type="text" name="card_number" id="card_number" class="form-control" placeholder="0000-0000-0000-0000" required>

            <!-- Card Holder Name -->
            <label for="cardholder_name">Card Holder Name*</label>
            <input type="text" name="cardholder_name" id="cardholder_name" class="form-control" placeholder="Your Name" required>
