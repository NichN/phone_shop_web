    ...
    <div class="container mt-4">
        <div class="row">
                ...
                <form id="contactForm" class="mt-5">
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control border-secondary" placeholder="Enter Your Name"
                                name="Name" id="name" required>
                        </div>
                        <div class="col">
                            <label class="fw-bold">Phone Number</label>
                            <input type="text" class="form-control border-secondary" placeholder="Enter Phone Number"
                                name="Phone" id="phone">
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="email" class="form-label fw-bold">Email address</label>
                            <input type="email" class="form-control border-secondary" id="email"
                                aria-describedby="emailHelp" placeholder="Enter Your Email" name="email" required>
            ...
            <div class="col">
                ...
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d125069.37724563181!2d104.86133282261211!3d11.593516216161756!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3109513a28530555%3A0x283e659a32b64e83!2sTay%20Meng%20Mobile%20Center!5e0!3m2!1sen!2skh!4v1737611391553!5m2!1sen!2skh"
...
Message:\n${formData.message}`;
            ...
            const telegramUrl =
                `https://api.telegram.org/bot${telegramBotToken}/sendMessage?chat_id=${telegramChatId}&text=${encodeURIComponent(telegramMessage)}`;
