        ...
        <div class="col-md-6">
            ...
            <form id="checkoutForm" method="GET">
                ...
                <div class="mb-3">
                    ...
                    {{-- <select class="form-select" name="payment_method" id="payment">
...
<script>
    document.getElementById('checkoutForm').addEventListener('submit', function(e) {
        ...
        if (method === 'cash') {
            window.location.href = "{{ route('payment.invoice') }}";
        } else if (method === 'card') {
            window.location.href = "{{ route('payment.card') }}"; // Create this view too
        } else {
